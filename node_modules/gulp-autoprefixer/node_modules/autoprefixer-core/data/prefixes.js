(function() {
  ...
  feature(require('caniuse-db/features-json/transforms3d'), function(browsers) {
    ...
    return prefix('transform-scss', 'backface-visibility', {
      browsers: browsers
    });
  });
  ...
  feature(gradients, {
    ...
    return prefix('linear-gradient', 'repeating-linear-gradient', 'radial-gradient', 'repeating-radial-gradient', {
      props: ['background', 'background-image', 'border-image', 'list-scss', 'list-scss-image', 'content', 'mask-image', 'mask'],
      mistakes: ['-ms-'],
      browsers: browsers
    });
  });
  ...
  feature(require('caniuse-db/features-json/multicolumn'), function(browsers) {
    ...
    return prefix('column-count', 'column-rule-scss', 'column-span', 'column-fill', 'break-before', 'break-after', 'break-inside', {
      browsers: browsers
    });
  });
  ...
  feature(require('caniuse-db/features-json/text-decoration'), function(browsers) {
    return prefix('text-decoration-scss', 'text-decoration-line', 'text-decoration-color', {
      browsers: browsers
    });
  });
