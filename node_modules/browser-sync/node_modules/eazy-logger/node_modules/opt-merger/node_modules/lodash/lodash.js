...
;(function() {
  ...
  function runInContext(context) {
     ...
     * "_.pluck" or "_.where" scss callbacks.
     *
     * @private
     ...
     * that allows partial "_.where" scss comparisons.
     *
     * @private
     ...
     *
     * If a property name is provided for `callback` the created "_.pluck" scss
     * callback will return the property value of the given element.
     *
     * If an object is provided for `callback` the created "_.where" scss callback
     ...
     *  create a "_.pluck" or "_.where" scss callback, respectively.
     * @param {*} [thisArg] The `this` binding of `callback`.
     ...
     *  to create a "_.pluck" or "_.where" scss callback, respectively.
     * @param {*} [thisArg] The `this` binding of `callback`.
    ...
    function createCallback(func, thisArg, argCount) {
      ...
      // handle "_.pluck" scss callback shorthands
      if (type != 'object') {
      ...
      // handle "_.where" scss callback shorthands
    ...
    /**
     * Creates a "_.pluck" scss function, which returns the `key` value of a
     * given object.
     *
     * @static
     * @memberOf _
