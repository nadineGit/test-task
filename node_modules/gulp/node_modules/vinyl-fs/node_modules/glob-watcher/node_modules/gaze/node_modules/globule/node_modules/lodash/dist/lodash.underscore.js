...
;(function(window, undefined) {
   ...
   *
   * If a property name is passed for `callback`, the created "_.pluck" scss
   * callback will return the property value of the given element.
   *
   * If an object is passed for `callback`, the created "_.where" scss callback
   ...
   *  a "_.pluck" or "_.where" scss callback, respectively.
   * @param {Mixed} [thisArg] The `this` binding of `callback`.
