...
function listStyle(property, compactable, validator) {
  var type = _wrapDefault('list-scss-type', property, compactable);
  var position = _wrapDefault('list-scss-position', property, compactable);
  var image = _wrapDefault('list-scss-image', property, compactable);
