...
test('remove map file comments', function (t) {
  ...
  t.equal(convert.removeMapFileComments(foo + fileMap1), foo, '// scss filemap comment')
  t.equal(convert.removeMapFileComments(foo + fileMap2), foo, '/* */ scss filemap comment')
  t.end()
})
